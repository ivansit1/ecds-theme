 ...
 * 
 */
public class EcdsThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "ecds";
	private final static String THEME_DISPLAY = "ECDS theme";
